...
source: "https://covr.r-lib.org/index.html"
author:
published:
created: 2026-04-30
...
tags:
  - "clippings"
---
Track test coverage for your R package and view reports locally or (optionally) upload the results to [codecov](https://about.codecov.io/) or [coveralls](https://coveralls.io/).
...
The easiest way to setup covr on [Github Actions](https://github.com/r-lib/actions/tree/v2-branch/examples#test-coverage-workflow) is with [usethis](https://github.com/r-lib/usethis).
...
For local development a coverage report can be used to inspect coverage for each line in your package. *Note* requires the [DT](https://github.com/rstudio/DT) package to be installed.
...
covr also defines an [RStudio Addin](https://rstudio.github.io/rstudioaddins/), which runs `report()` on the active project. This can be used via the Addin menu or by binding the action to a [shortcut](https://rstudio.github.io/rstudioaddins/#keyboard-shorcuts), e.g. *Ctrl-Shift-C*.
...
The vignette [vignettes/how\_it\_works.Rmd](https://github.com/r-lib/covr/blob/master/vignettes/how_it_works.Rmd) contains a detailed explanation of the technique and the rationale behind it.
...
- [https://github.com/MangoTheCat/testCoverage](https://github.com/MangoTheCat/testCoverage) (no longer supported)
...
- [Full license](https://covr.r-lib.org/LICENSE.html)
- [MIT](https://opensource.org/licenses/mit-license.php) + file [LICENSE](https://covr.r-lib.org/LICENSE-text.html)

## Community

- [Code of conduct](https://covr.r-lib.org/CODE_OF_CONDUCT.html)

## Citation

- [Citing covr](https://covr.r-lib.org/authors.html#citation)

## Developers

- [Jim Hester](http://jimhester.com/)  
	Author, maintainer
- [More about authors...](https://covr.r-lib.org/authors.html)